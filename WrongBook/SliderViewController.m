...
@property (nonatomic, strong, readwrite) JFBaseViewController *mainViewController;
@property (nonatomic, strong, readwrite) JFBaseViewController *leftViewController;
@property (nonatomic, strong, readwrite) JFBaseViewController *rightViewController;
@end
...
- (void)setMainViewController:(JFBaseViewController *)mainViewController
{
...
- (void)setLeftViewController:(JFBaseViewController *)leftViewController
{
...
- (void)setRightViewController:(JFBaseViewController *)rightViewController
{
 ...
 */
- (JFBaseNavigationController *)sliderNavigationController
{
    if (self.mainViewController) {
        if ([self.mainViewController isKindOfClass:[JFBaseNavigationController class]]) {
            return (JFBaseNavigationController *)self.mainViewController;
        }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    if ([_mainViewController isKindOfClass:[JFBaseNavigationController class]]) {
        ...
        for (UIViewController *controller in _mainViewController.childViewControllers) {
            if ([controller isKindOfClass:[JFBaseNavigationController class]]) {
