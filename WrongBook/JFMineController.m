...
@interface JFMineController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    _imageArray = [[NSMutableArray alloc]initWithArray:@[@"高考2",@"高考5"]];
    _contentArray = [[NSMutableArray alloc]initWithArray:@[@"诗歌鉴赏试题答题方法步骤及答题模式",@"做到这十条，作文次次满分！"]];
    _countArray = [[NSMutableArray alloc]initWithArray:@[@"9000",@"439"]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.button setTitle:@"退出" forState:UIControlStateNormal];
...
- (void)buttonAction:(UIButton *)sender{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:nil message:@"您已成功退出" preferredStyle:UIAlertControllerStyleAlert];
