...
@implementation JFHistoryController
...
- (void)viewDidLoad {
    ...
    questionArray = @[@"下列字注音全都正确的一项是（ ）A. 绮（qí）丽 桑乾（gān） 戕（qiāng）害 休戚（qiè）相关 B. 翘（qiáo）首 愀然（qiǎo） 静谧（mì） 熠熠（y ì）闪光 C. 不啻（chì） 炽（zhì）热 饿殍（piāo） 锲（qiè）而不舍 D. 慰藉（jiè ） 脊（j ǐ）梁 烙（lào）印 铩（shà）羽而归 "];
    objectArray = @[@"语文"];
    
//    questionArray = @[
//    @"下列字注音全都正确的一项是（ ）A. 绮（qí）丽 桑乾（gān） 戕（qiāng）害 休戚（qiè）相关 B. 翘（qiáo）首 愀然（qiǎo） 静谧（mì） 熠熠（y ì）闪光 C. 不啻（chì） 炽（zhì）热 饿殍（piāo） 锲（qiè）而不舍 D. 慰藉（jiè ） 脊（j ǐ）梁 烙（lào）印 铩（shà）羽而归 ",
...
//    @"The reason _____ he was late for the meeting is _____ his car broke down on the road.    A.  why; that B.  why; because C.  that; that D.  for which; because",
//    @"下列文学常识中有误的一项是：（  ）A、《孟子》一书共分为七篇，其中多数为论辩文章。孟子的文章富于雄辩，气势充沛，感情强烈，同时他又善于运用比喻等手法，将抽象道理具体化，使文章引人入胜，具有很高的文学价值。B、曹雪芹，中国清代小说家，字梦阮，号雪芹。他创作的《红楼梦》原名《石头记》是我国古代长篇小说中现实主义的高峰。《红楼梦》共120回，前80回为曹雪芹所写，后40回为高鹗所续。C、《祝福》选自《呐喊》，作者是鲁迅，他的另两部小说集是《彷徨》《故事新编》，散文集是《朝花夕拾》，散文诗集是《野草》，还有杂文17部。 D、海明威是美国现代作家。代表作有《太阳照常升起》、《永别了，武器》、《丧钟为谁而鸣》、《老人与海》等。在《老人与海》中，作者通过主人公桑地亚哥塑造了“硬汉”性格。"];
//    objectArray = @[@"语文",@"语文",@"数学",@"地理",@"英语",@"语文",@"数学",@"地理",@"英语",@"地理",@"英语",@"地理",@"英语",@"语文",@"语文",@"语文",@"数学",@"地理",@"英语",@"语文",@"数学",@"地理",@"英语",@"地理",@"英语",@"地理",@"英语",@"语文"];
    [self loadData];
...
- (void)startToReview{
    JFSimilarController *controller = [[JFSimilarController alloc]init];
